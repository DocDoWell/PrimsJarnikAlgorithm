    ...
    public void run(Vertex vertex) {
        ...
        while(!unvisited.isEmpty()) {
            ...
            for(Edge edge : vertex.getAdjacentVertices()) {
                if(unvisited.contains(edge.getTarget())) {
                    heap.add(edge);
                }
            }
            ...
            if(!unvisited.contains(minEdge.getTarget()))
                continue;
...
public void printSolution(){
        System.out.println("Cost of Minimum Spanning Tree is " + this.fullCost);
